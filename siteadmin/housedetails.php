...
<?php include_once("headerad.php");?>
   ...
   <h2 align="center" style="color:#0C3; text-transform:uppercase;">House details</h2>
     <HR>
          <BR>
					<BR>
...
echo "<td><a class='btn btn-info' href='edit_houses.php?id=".$row['id']."'>Edit</a><br>";
if($row['status'] == 'ACTIVE'){
echo "<a class='btn btn-info' href='inactivate_houses.php?id=".$row['id']."'>Inactivate</a><br>";
}else{
echo "<a class='btn btn-info' href='activate_houses.php?id=".$row['id']."'>Activate</a><br>";
}
echo "<a class='btn btn-info' href='delete_houses.php?id=".$row['id']."'>Delete</a></td>";
echo "</tr>";
}
echo "</tbody></table>";
mysql_close($con);
