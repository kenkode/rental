...
<link rel="stylesheet" href="css/bootstrap.min.css" type="text/css">
 <title>View Vacant Houses</title>
...
<?php include_once("headerad2.php");?>
   ...
   <h2 align="center" style="color:#0C3; text-transform:uppercase;">View Vacant Houses</h2>
     <HR>
          <BR>
					<BR>
...
<?php
$result = mysql_query("SELECT * FROM houses where houses.building_id='".$l['building_id']."' AND houses.status='VACANT'") or die(mysql_error());
$i=0;
