...
echo "<td><a class='btn btn-info' href='edit_landlords.php?id=".$row['ownid']."'>Edit</a><br>";
if($row['status'] == 'ACTIVE'){
echo "<a class='btn btn-info' href='inactivate_landlords.php?id=".$row['ownid']."'>Inactivate</a><br>";
}else{
echo "<a class='btn btn-info' href='activate_landlords.php?id=".$row['ownid']."'>Activate</a><br>";
}
echo "<a class='btn btn-info' href='delete_landlords.php?id=".$row['ownid']."'>Delete</a></td>";
echo "</tr>";
}
echo "</tbody></table>";
mysql_close($con);
