...
echo "<td><a class='btn btn-info' href='e_edit_tenants.php?id=".$row['id']."'>Edit</a><br>";
if($row['status'] == 'ACTIVE'){
echo "<a class='btn btn-info' href='e_inactivate_tenants.php?id=".$row['id']."'>Inactivate</a><br>";
}else{
echo "<a class='btn btn-info' href='e_activate_tenants.php?id=".$row['id']."'>Activate</a><br>";
}
echo "<a class='btn btn-info' href='e_delete_tenants.php?id=".$row['id']."'>Delete</a></td>";
echo "</tr>";
}
echo "</tbody></table>";
mysql_close($con);
