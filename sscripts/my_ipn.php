...
if (strpos($curl_result, "VERIFIED") !== false) {
	...
	mail("wangoken2@gmail.com", "IPN interaction not verified", "$req", "From: wangoken2@gmail.com" );
	exit();
}
...
if ($receiver_email != "wangoken2@gmail.com") {
	$message = "Investigate why and how receiver email is wrong. Email = " . $_POST['receiver_email'] . "\n\n\n$req";
    mail("wangoken2@gmail.com", "Receiver Email is incorrect", $message, "From: wangoken2@gmail.com" );
    exit(); // exit script
}
// Check number 2 ------------------------------------------------------------------------------------------------------------
...
if ($fullAmount != $grossAmount) {
        ...
        mail("wangoken2@gmail.com", "Price Jack or Bad Programming", $message, "From: wangoken2@gmail.com" );
        exit(); // exit script
} 
